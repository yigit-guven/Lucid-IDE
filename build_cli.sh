...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/yigit-guven/Lucid-IDE/refs/heads/main/versions"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/yigit-guven/Lucid-IDE/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/yigit-guven/Lucid-IDE/releases"
fi
