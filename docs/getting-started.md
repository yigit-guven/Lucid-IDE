...
# Getting Started with Lucid IDE

This guide will help you get started with Lucid IDE.
...
Lucid IDE can be installed on Windows, macOS, and Linux. Visit the [download page](https://Lucid IDE.com/#install) for installation instructions.

## <a id="first-steps"></a>First Steps

After installing Lucid IDE, here are some first steps to get started:
...
Lucid IDE works just like Visual Studio Code, with a few differences:
...
- Explore the [documentation](https://github.com/yigit-guven/Lucid-IDE/blob/master/docs/index.md) for more details
- Join the [community](https://github.com/yigit-guven/Lucid-IDE/discussions) to ask questions and share tips
- Contribute to the [project](https://github.com/yigit-guven/Lucid-IDE/blob/master/CONTRIBUTING.md) if you're interested
