...
APP_NAME="${APP_NAME:-LucidIDE}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-yigit-guven/Lucid-IDE}"
BINARY_NAME="${BINARY_NAME:-lucid}"
GH_REPO_PATH="${GH_REPO_PATH:-yigit-guven/Lucid-IDE}"
ORG_NAME="${ORG_NAME:-yigit-guven}"
